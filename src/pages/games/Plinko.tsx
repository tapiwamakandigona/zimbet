...
export function Plinko() {
    ...
    useEffect(() => {
        ...
        const handleResize = () => {
            ...
            // Target aspect ratio (800 / 650)
            const aspectRatio = worldWidth / worldHeight

            // Calculate new dimensions to fit in container (contain)
            ...
            // Update render options to match new size
            render.options.width = newWidth * pixelRatio
            render.options.height = newHeight * pixelRatio

            // Ensure bounds show the full world
